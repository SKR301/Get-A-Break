...
def showAlert(root):
	...
	# var.set("B")
	# newTimeInput = tkinter.Entry(root, width = 150)
	# # newTimeInput.place(x=30, y=75)
	...
	dropup_btn = tkinter.Button(root, image = dropup_img, borderwidth = 0, command = lambda: hideNewTimeOption(newTimelabel, dropdown_btn, dropup_btn))
	dropup_btn.place(x=25,y=55)

	dropdown_img = tkinter.PhotoImage(file = "./drawable/dropdown_btn.png")
	dropdown_btn = tkinter.Button(root, image = dropdown_img, borderwidth = 0, command = lambda: showNewTimeOption(newTimelabel, dropdown_btn, dropup_btn))
...
def showNewTimeOption(newTimelabel, dropdown_btn, dropup_btn):
	newTimelabel.place(x=10, y=75)
	dropdown_btn.place_forget()	
	dropup_btn.place(x=25,y=55)


def hideNewTimeOption(newTimelabel, dropdown_btn, dropup_btn):
